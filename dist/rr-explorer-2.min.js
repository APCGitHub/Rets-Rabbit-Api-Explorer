...
!function(){"use strict";function r(){function r(){var r=this;r.data={searchForm:{select:[{value:""}],filter:[{value:"",operator:""}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},request:"",results:[]}}return{restrict:"EA",scope:{},templateUrl:"explorer.bootstrap.html",controller:r,controllerAs:"vm",bindToController:!0}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",r),r.$inject=[]}();
