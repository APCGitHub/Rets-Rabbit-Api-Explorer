...
!function(){"use strict";function e(e,a){var r=["$scope","$interval","$document","PropertyFactory","uiGmapGoogleMapApi","uiGmapIsReady",function(a,r,t,o,n,l){function i(e){if(e){h.data.total_results=-1,h.data.error=null,h.data.results=null,h.data.searching=!0;var a=new Date;o.search(h.data.request).then(function(e){t.scrollToElement(f,70,300);var r=new Date;h.data.error=null,h.data.results=e,h.data.total_results=e.value.length,h.data.searching=!1,g(r.getTime()-a.getTime())},function(e){t.scrollToElement(f,70,300),h.data.query_time=-1,h.data.searching=!1,h.data.error=e?e.error:{}})}}function d(){h.data.searchForm.filter.push({value:"",join:"and"})}function s(e){var a=h.data.searchForm.filter.indexOf(e);h.data.searchForm.filter.splice(a,1),p()}function c(){h.data.searchForm.orderby.push({value:"",direction:"asc"})}function u(e){var a=h.data.searchForm.orderby.indexOf(e);h.data.searchForm.orderby.splice(a,1),p()}function p(){var a="",r=0,t=[0,0,0,0,0];if(""!==h.data.searchForm.select&&(t[0]=1,a+="$select="+h.data.searchForm.select),h.data.searchForm.filter.length)for(t[1]=1,a+=t[0]?"&$filter=":"$filter=",r=0;r<h.data.searchForm.filter.length;r++)a+=h.data.searchForm.filter[r].value,""!==h.data.searchForm.filter[r].value&&r+1<h.data.searchForm.filter.length&&(a+=" "+h.data.searchForm.filter[r].join),r+1<h.data.searchForm.filter.length&&(a+=" ");h.data.searchForm.orderby.length&&(t[2]=1,a+=t[0]+t[1]>0?"&$orderby=":"$orderby=",a+=h.data.searchForm.orderby.map(function(e){return""!==e.value?e.value+" "+e.direction:""}).join(", ")),""!=h.data.searchForm.top&&(t[3]=1,a+=t[0]+t[1]+t[2]>0?"&$top=":"$top=",a+=h.data.searchForm.top),""!=h.data.searchForm.skip&&(t[4]=1,a+=t[0]+t[1]+t[2]+t[3]>0?"&$skip=":"$skip=",a+=h.data.searchForm.skip),h.data.fullRequest=e.apiUrl+"property?"+a,h.data.request=a}function g(e){h.data.query_time=0;var a=5;e>750?h.data.query_time=e:m=r(function(a){h.data.query_time==e?r.cancel(m):h.data.query_time++},a)}var m,h=this,f=angular.element(document.getElementById("rr-query-results")),y={fillColor:"#ec6952",fillOpacity:.5,editable:!0,zIndex:1,clickable:!1,strokeWeight:3};a.$watch(angular.bind(this,function(){return this.search}),function(e){e&&"undefined"!==e&&void 0!==e&&"function"!=typeof e&&(h.data.searchForm.select=e.query.select,h.data.searchForm.filter=e.query.filter,h.data.searchForm.orderby=e.query.orderby,h.data.searchForm.top=e.query.top,h.data.searchForm.skip=e.query.skip,h.data.error=null,h.data.results=null,h.data.searching=!1,h.data.total_results=-1,p())}),h.data={searchForm:{select:"",filter:[{value:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},map:{center:{latitude:39.9612,longitude:-82.9988},zoom:10,drawingManagerOptions:{},drawingManagerControl:{},bounds:{}},fullRequest:e.apiUrl+"property?",request:"",results:null,total_results:-1,error:null,searching:!1,query_time:-1},n.then(function(e){h.data.map.drawingManagerOptions={drawingMode:google.maps.drawing.OverlayType.MARKER,drawingControl:!0,drawingControlOptions:{position:google.maps.ControlPosition.TOP_CENTER,drawingModes:[google.maps.drawing.OverlayType.CIRCLE,google.maps.drawing.OverlayType.POLYGON,google.maps.drawing.OverlayType.RECTANGLE]},polygonOptions:{},circleOptions:{},rectangleOptions:{}},angular.extend(h.data.map.drawingManagerOptions.polygonOptions,y),angular.extend(h.data.map.drawingManagerOptions.circleOptions,y),angular.extend(h.data.map.drawingManagerOptions.rectangleOptions,y)}),l.promise().then(function(e){google.maps.event.addListener(h.data.map.drawingManagerControl.getDrawingManager(),"circlecomplete",function(e){console.log(e)}),google.maps.event.addListener(h.data.map.drawingManagerControl.getDrawingManager(),"polygoncomplete",function(e){console.log(e)}),google.maps.event.addListener(h.data.map.drawingManagerControl.getDrawingManager(),"rectanglecomplete",function(e){console.log(e)})}),h.doSearch=i,h.addFilter=d,h.removeFilter=s,h.addOrderby=c,h.removeOrderby=u,h.updateQuery=p}];return{restrict:"EA",scope:!0,link:function(e,a,r,t){},templateUrl:"explorer.bootstrap.html",controller:r,controllerAs:"vm",bindToController:{search:"=",loader:"="}}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",e),e.$inject=["ApiConfig","PropertyFactory"]}();
