...
!function(){"use strict";function a(a,e){var r=["$scope","$interval","$document","PropertyFactory","uiGmapGoogleMapApi","uiGmapIsReady",function(e,r,t,n,l,o){function i(a){if(a){y.data.total_results=-1,y.data.error=null,y.data.results=null,y.data.searching=!0;var e=new Date;n.search(y.data.request).then(function(a){t.scrollToElement(v,70,300);var r=new Date;y.data.error=null,y.data.results=a,y.data.total_results=a.value.length,y.data.searching=!1,u(r.getTime()-e.getTime())},function(a){t.scrollToElement(v,70,300),y.data.query_time=-1,y.data.searching=!1,y.data.error=a?a.error:{}})}}function s(){y.data.searchForm.filter.push({value:"",join:"and"})}function d(a){var e=y.data.searchForm.filter.indexOf(a);y.data.searchForm.filter.splice(e,1),p()}function c(){y.data.searchForm.orderby.push({value:"",direction:"asc"})}function g(a){var e=y.data.searchForm.orderby.indexOf(a);y.data.searchForm.orderby.splice(e,1),p()}function p(){var e="",r=0,t=[0,0,0,0,0];if(""!==y.data.searchForm.select&&(t[0]=1,e+="$select="+y.data.searchForm.select),y.data.searchForm.filter.length)for(t[1]=1,e+=t[0]?"&$filter=":"$filter=",r=0;r<y.data.searchForm.filter.length;r++)e+=y.data.searchForm.filter[r].value,""!==y.data.searchForm.filter[r].value&&r+1<y.data.searchForm.filter.length&&(e+=" "+y.data.searchForm.filter[r].join),r+1<y.data.searchForm.filter.length&&(e+=" ");y.data.searchForm.orderby.length&&(t[2]=1,e+=t[0]+t[1]>0?"&$orderby=":"$orderby=",e+=y.data.searchForm.orderby.map(function(a){return""!==a.value?a.value+" "+a.direction:""}).join(", ")),""!=y.data.searchForm.top&&(t[3]=1,e+=t[0]+t[1]+t[2]>0?"&$top=":"$top=",e+=y.data.searchForm.top),""!=y.data.searchForm.skip&&(t[4]=1,e+=t[0]+t[1]+t[2]+t[3]>0?"&$skip=":"$skip=",e+=y.data.searchForm.skip),y.data.fullRequest=a.apiUrl+"property?"+e,y.data.request=e}function u(a){y.data.query_time=0;var e=5;a>750?y.data.query_time=a:f=r(function(e){y.data.query_time==a?r.cancel(f):y.data.query_time++},e)}function m(a){switch(a){case 1:y.data.map.shape.rectangle=null,y.data.map.shape.polygon=null;break;case 2:y.data.map.shape.circle=null,y.data.map.shape.polygon=null;break;case 3:y.data.map.shape.circle=null,y.data.map.shape.rectangle=null}}function h(a){m(1);var e=null===y.data.map.shape.circle;y.data.map.shape.circle=a;var r=a.getRadius(),t={lat:a.center.lat(),lng:a.center.lng()};console.log(JSON.stringify(t)+" "+r),e&&(google.maps.event.addListener(y.data.map.shape.circle,"radius_changed",function(){console.log("radius change");var a=y.data.map.shape.circle.getRadius(),e={lat:y.data.map.shape.circle.center.lat(),lng:y.data.map.shape.circle.center.lng()};console.log(JSON.stringify(e)+" "+a)}),google.maps.event.addListener(y.data.map.shape.circle,"dragend",function(){console.log("dragend change");var a=y.data.map.shape.circle.getRadius(),e={lat:y.data.map.shape.circle.center.lat(),lng:y.data.map.shape.circle.center.lng()};console.log(JSON.stringify(e)+" "+a)}))}var f,y=this,v=angular.element(document.getElementById("rr-query-results")),F={fillColor:"#ec6952",fillOpacity:.5,editable:!0,draggable:!0,zIndex:1,clickable:!1,strokeWeight:3,geodesic:!0};e.$watch(angular.bind(this,function(){return this.search}),function(a){a&&"undefined"!==a&&void 0!==a&&"function"!=typeof a&&(y.data.searchForm.select=a.query.select,y.data.searchForm.filter=a.query.filter,y.data.searchForm.orderby=a.query.orderby,y.data.searchForm.top=a.query.top,y.data.searchForm.skip=a.query.skip,y.data.error=null,y.data.results=null,y.data.searching=!1,y.data.total_results=-1,p())}),y.data={searchForm:{select:"",filter:[{value:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},map:{center:{latitude:39.9612,longitude:-82.9988},zoom:11,drawingManagerOptions:{},drawingManagerControl:{},bounds:{},shape:{circle:null,rectangle:null,polygon:null}},fullRequest:a.apiUrl+"property?",request:"",results:null,total_results:-1,error:null,searching:!1,query_time:-1},l.then(function(a){y.data.map.drawingManagerOptions={drawingMode:google.maps.drawing.OverlayType.MARKER,drawingControl:!0,drawingControlOptions:{position:google.maps.ControlPosition.TOP_CENTER,drawingModes:[google.maps.drawing.OverlayType.CIRCLE,google.maps.drawing.OverlayType.POLYGON,google.maps.drawing.OverlayType.RECTANGLE]},polygonOptions:{},circleOptions:{},rectangleOptions:{}},angular.extend(y.data.map.drawingManagerOptions.polygonOptions,F),angular.extend(y.data.map.drawingManagerOptions.circleOptions,F),angular.extend(y.data.map.drawingManagerOptions.rectangleOptions,F)}),o.promise().then(function(a){google.maps.event.addListener(y.data.map.drawingManagerControl.getDrawingManager(),"circlecomplete",function(a){h(a)}),google.maps.event.addListener(y.data.map.drawingManagerControl.getDrawingManager(),"polygoncomplete",function(a){for(var e=[],r=0;r<a.getPath().getLength();r++){var t=a.getPath().getAt(r);e.push({lat:t.lat(),lng:t.lng()})}}),google.maps.event.addListener(y.data.map.drawingManagerControl.getDrawingManager(),"rectanglecomplete",function(a){y.data.map.shape.rectangle=a;var e=[],r=a.getBounds(),t=r.getNorthEast(),n=r.getSouthWest();e.push({lat:t.lat(),lng:n.lng()}),e.push({lat:t.lat(),lng:t.lng()}),e.push({lat:n.lat(),lng:t.lng()}),e.push({lat:n.lat(),lng:n.lng()})})}),y.doSearch=i,y.addFilter=s,y.removeFilter=d,y.addOrderby=c,y.removeOrderby=g,y.updateQuery=p}];return{restrict:"EA",scope:!0,link:function(a,e,r,t){},templateUrl:"explorer.bootstrap.html",controller:r,controllerAs:"vm",bindToController:{search:"=",loader:"="}}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",a),a.$inject=["ApiConfig","PropertyFactory"]}();
