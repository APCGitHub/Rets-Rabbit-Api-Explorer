...
!function(){"use strict";function e(e,r){var a=["$scope","$interval","$document","PropertyFactory","uiGmapGoogleMapApi",function(r,a,t,o,n){function l(e){if(e){m.data.total_results=-1,m.data.error=null,m.data.results=null,m.data.searching=!0;var r=new Date;o.search(m.data.request).then(function(e){t.scrollToElement(h,70,300);var a=new Date;m.data.error=null,m.data.results=e,m.data.total_results=e.value.length,m.data.searching=!1,p(a.getTime()-r.getTime())},function(e){t.scrollToElement(h,70,300),m.data.query_time=-1,m.data.searching=!1,m.data.error=e?e.error:{}})}}function i(){m.data.searchForm.filter.push({value:"",join:"and"})}function d(e){var r=m.data.searchForm.filter.indexOf(e);m.data.searchForm.filter.splice(r,1),u()}function s(){m.data.searchForm.orderby.push({value:"",direction:"asc"})}function c(e){var r=m.data.searchForm.orderby.indexOf(e);m.data.searchForm.orderby.splice(r,1),u()}function u(){var r="",a=0,t=[0,0,0,0,0];if(""!==m.data.searchForm.select&&(t[0]=1,r+="$select="+m.data.searchForm.select),m.data.searchForm.filter.length)for(t[1]=1,r+=t[0]?"&$filter=":"$filter=",a=0;a<m.data.searchForm.filter.length;a++)r+=m.data.searchForm.filter[a].value,""!==m.data.searchForm.filter[a].value&&a+1<m.data.searchForm.filter.length&&(r+=" "+m.data.searchForm.filter[a].join),a+1<m.data.searchForm.filter.length&&(r+=" ");m.data.searchForm.orderby.length&&(t[2]=1,r+=t[0]+t[1]>0?"&$orderby=":"$orderby=",r+=m.data.searchForm.orderby.map(function(e){return""!==e.value?e.value+" "+e.direction:""}).join(", ")),""!=m.data.searchForm.top&&(t[3]=1,r+=t[0]+t[1]+t[2]>0?"&$top=":"$top=",r+=m.data.searchForm.top),""!=m.data.searchForm.skip&&(t[4]=1,r+=t[0]+t[1]+t[2]+t[3]>0?"&$skip=":"$skip=",r+=m.data.searchForm.skip),m.data.fullRequest=e.apiUrl+"property?"+r,m.data.request=r}function p(e){m.data.query_time=0;var r=5;e>750?m.data.query_time=e:g=a(function(r){m.data.query_time==e?a.cancel(g):m.data.query_time++},r)}var g,m=this,h=angular.element(document.getElementById("rr-query-results")),y={fillColor:"#ec6952",fillOpacity:.3,editable:!0,zIndex:1,clickable:!1,strokeWeight:5};r.$watch(angular.bind(this,function(){return this.search}),function(e){e&&"undefined"!==e&&void 0!==e&&"function"!=typeof e&&(m.data.searchForm.select=e.query.select,m.data.searchForm.filter=e.query.filter,m.data.searchForm.orderby=e.query.orderby,m.data.searchForm.top=e.query.top,m.data.searchForm.skip=e.query.skip,m.data.error=null,m.data.results=null,m.data.searching=!1,m.data.total_results=-1,u())}),m.data={searchForm:{select:"",filter:[{value:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},map:{center:{latitude:39.9612,longitude:-82.9988},zoom:10,drawingManagerOptions:{},drawingManagerControl:{},bounds:{}},fullRequest:e.apiUrl+"property?",request:"",results:null,total_results:-1,error:null,searching:!1,query_time:-1},n.then(function(e){console.log("google maps is ready now"),m.data.map.drawingManagerOptions={drawingMode:google.maps.drawing.OverlayType.MARKER,drawingControl:!0,drawingControlOptions:{position:google.maps.ControlPosition.TOP_CENTER,drawingModes:[google.maps.drawing.OverlayType.MARKER,google.maps.drawing.OverlayType.CIRCLE,google.maps.drawing.OverlayType.POLYGON,google.maps.drawing.OverlayType.POLYLINE,google.maps.drawing.OverlayType.RECTANGLE]},polygonOptions:{},circleOptions:{}},angular.extend(m.data.map.drawingManagerOptions.polygonOptions,y),angular.extend(m.data.map.drawingManagerOptions.circleOptions,y),angular.extend(m.data.map.drawingManagerOptions.rectangleOptions,y)}),m.doSearch=l,m.addFilter=i,m.removeFilter=d,m.addOrderby=s,m.removeOrderby=c,m.updateQuery=u}];return{restrict:"EA",scope:!0,link:function(e,r,a,t){},templateUrl:"explorer.bootstrap.html",controller:a,controllerAs:"vm",bindToController:{search:"=",loader:"="}}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",e),e.$inject=["ApiConfig","PropertyFactory"]}();
