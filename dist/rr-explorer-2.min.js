...
!function(){"use strict";function e(e){function t(e){function t(){}function r(){c.data.searchForm.select.push({value:""})}function a(){c.data.searchForm.filter.push({value:""})}function o(){c.data.searchForm.orderby.push({value:""})}var c=this;c.data={searchForm:{select:[{value:""}],filter:[{value:"",operator:""}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},request:"",results:[]},c.search=t,c.addSelect=r,c.addFilter=a,c.addOrderby=o,c.watchCollection("data.searchForm.select",_updateRequest),c.watchCollection("data.searchForm.filter",_updateRequest),c.watchCollection("data.searchForm.orderby",_updateRequest),c.watch("data.searchForm.top",_updateRequest),c.watch("data.searchForm.skip",_updateRequest)}return{restrict:"EA",scope:{},templateUrl:"explorer.bootstrap.html",link:function(e,t,r){},controller:t,controllerAs:"vm",bindToController:!0}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",e),e.$inject=["PropertyFactory"]}();
