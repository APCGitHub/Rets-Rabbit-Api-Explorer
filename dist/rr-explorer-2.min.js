...
!function(){"use strict";function e(e,a){var r=["$scope","$interval","$document","PropertyFactory","uiGmapGoogleMapApi",function(a,r,t,o,n){function l(e){if(e){m.data.total_results=-1,m.data.error=null,m.data.results=null,m.data.searching=!0;var a=new Date;o.search(m.data.request).then(function(e){t.scrollToElement(h,70,300);var r=new Date;m.data.error=null,m.data.results=e,m.data.total_results=e.value.length,m.data.searching=!1,p(r.getTime()-a.getTime())},function(e){t.scrollToElement(h,70,300),m.data.query_time=-1,m.data.searching=!1,m.data.error=e?e.error:{}})}}function i(){m.data.searchForm.filter.push({value:"",join:"and"})}function d(e){var a=m.data.searchForm.filter.indexOf(e);m.data.searchForm.filter.splice(a,1),u()}function s(){m.data.searchForm.orderby.push({value:"",direction:"asc"})}function c(e){var a=m.data.searchForm.orderby.indexOf(e);m.data.searchForm.orderby.splice(a,1),u()}function u(){var a="",r=0,t=[0,0,0,0,0];if(""!==m.data.searchForm.select&&(t[0]=1,a+="$select="+m.data.searchForm.select),m.data.searchForm.filter.length)for(t[1]=1,a+=t[0]?"&$filter=":"$filter=",r=0;r<m.data.searchForm.filter.length;r++)a+=m.data.searchForm.filter[r].value,""!==m.data.searchForm.filter[r].value&&r+1<m.data.searchForm.filter.length&&(a+=" "+m.data.searchForm.filter[r].join),r+1<m.data.searchForm.filter.length&&(a+=" ");m.data.searchForm.orderby.length&&(t[2]=1,a+=t[0]+t[1]>0?"&$orderby=":"$orderby=",a+=m.data.searchForm.orderby.map(function(e){return""!==e.value?e.value+" "+e.direction:""}).join(", ")),""!=m.data.searchForm.top&&(t[3]=1,a+=t[0]+t[1]+t[2]>0?"&$top=":"$top=",a+=m.data.searchForm.top),""!=m.data.searchForm.skip&&(t[4]=1,a+=t[0]+t[1]+t[2]+t[3]>0?"&$skip=":"$skip=",a+=m.data.searchForm.skip),m.data.fullRequest=e.apiUrl+"property?"+a,m.data.request=a}function p(e){m.data.query_time=0;var a=5;e>750?m.data.query_time=e:g=r(function(a){m.data.query_time==e?r.cancel(g):m.data.query_time++},a)}var g,m=this,h=angular.element(document.getElementById("rr-query-results")),y={fillColor:"#ec6952",fillOpacity:.5,editable:!0,zIndex:1,clickable:!1,strokeWeight:5};a.$watch(angular.bind(this,function(){return this.search}),function(e){e&&"undefined"!==e&&void 0!==e&&"function"!=typeof e&&(m.data.searchForm.select=e.query.select,m.data.searchForm.filter=e.query.filter,m.data.searchForm.orderby=e.query.orderby,m.data.searchForm.top=e.query.top,m.data.searchForm.skip=e.query.skip,m.data.error=null,m.data.results=null,m.data.searching=!1,m.data.total_results=-1,u())}),m.data={searchForm:{select:"",filter:[{value:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},map:{center:{latitude:39.9612,longitude:-82.9988},zoom:10,drawingManagerOptions:{},drawingManagerControl:{},bounds:{}},fullRequest:e.apiUrl+"property?",request:"",results:null,total_results:-1,error:null,searching:!1,query_time:-1},n.then(function(e){m.data.map.drawingManagerOptions={drawingMode:google.maps.drawing.OverlayType.MARKER,drawingControl:!0,drawingControlOptions:{position:google.maps.ControlPosition.TOP_CENTER,drawingModes:[google.maps.drawing.OverlayType.MARKER,google.maps.drawing.OverlayType.CIRCLE,google.maps.drawing.OverlayType.POLYGON,google.maps.drawing.OverlayType.POLYLINE,google.maps.drawing.OverlayType.RECTANGLE]},polygonOptions:{},circleOptions:{},events:{polygonEvents:{dblck:{}}}},angular.extend(m.data.map.drawingManagerOptions.polygonOptions,y),angular.extend(m.data.map.drawingManagerOptions.circleOptions,y),angular.extend(m.data.map.drawingManagerOptions.rectangleOptions,y),google.maps.event.addListener(drawingManager,"circlecomplete",function(e){e.getRadius()})}),m.doSearch=l,m.addFilter=i,m.removeFilter=d,m.addOrderby=s,m.removeOrderby=c,m.updateQuery=u}];return{restrict:"EA",scope:!0,link:function(e,a,r,t){},templateUrl:"explorer.bootstrap.html",controller:r,controllerAs:"vm",bindToController:{search:"=",loader:"="}}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",e),e.$inject=["ApiConfig","PropertyFactory"]}();
