...
!function(){"use strict";function r(r,e){var a=["$scope","$document","PropertyFactory",function(e,a,t){function o(r){if(r){var e=angular.element(document.getElementById("query-results"));a.scrollToElement(e,80,300),d.data.total_results=-1,d.data.error=null,d.data.results=null,d.data.searching=!0;var o=new Date;t.search(d.data.request).then(function(r){var e=new Date;console.log(o.getTime()-e.getTime()),d.data.error=null,d.data.results=r,d.data.total_results=r.value.length,d.data.searching=!1},function(r){d.data.searching=!1,d.data.error=r.error})}}function l(){d.data.searchForm.filter.push({value:"",join:"and"})}function s(r){var e=d.data.searchForm.filter.indexOf(r);d.data.searchForm.filter.splice(e,1),c()}function i(){d.data.searchForm.orderby.push({value:"",direction:"asc"})}function n(r){var e=d.data.searchForm.orderby.indexOf(r);d.data.searchForm.orderby.splice(e,1),c()}function c(){var e="",a=0,t=[0,0,0,0,0];if(""!==d.data.searchForm.select&&(t[0]=1,e+="$select="+d.data.searchForm.select),d.data.searchForm.filter.length)for(t[1]=1,e+=t[0]?"&$filter=":"$filter=",a=0;a<d.data.searchForm.filter.length;a++)e+=d.data.searchForm.filter[a].value,""!==d.data.searchForm.filter[a].value&&a+1<d.data.searchForm.filter.length&&(e+=" "+d.data.searchForm.filter[a].join),a+1<d.data.searchForm.filter.length&&(e+=" ");d.data.searchForm.orderby.length&&(t[2]=1,e+=t[0]+t[1]>0?"&$orderby=":"$orderby=",e+=d.data.searchForm.orderby.map(function(r){return""!==r.value?r.value+" "+r.direction:""}).join(", ")),""!=d.data.searchForm.top&&(t[3]=1,e+=t[0]+t[1]+t[2]>0?"&$top=":"$top=",e+=d.data.searchForm.top),""!=d.data.searchForm.skip&&(t[4]=1,e+=t[0]+t[1]+t[2]+t[3]>0?"&$skip=":"$skip=",e+=d.data.searchForm.skip),d.data.fullRequest=r.apiUrl+"property?"+e,d.data.request=e}var d=this;e.$watch(angular.bind(this,function(){return this.search}),function(r){r&&"undefined"!==r&&void 0!==r&&"function"!=typeof r&&(d.data.searchForm.select=r.query.select,d.data.searchForm.filter=r.query.filter,d.data.searchForm.orderby=r.query.orderby,d.data.searchForm.top=r.query.top,d.data.searchForm.skip=r.query.skip,c())}),d.data={searchForm:{select:"",filter:[{value:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},fullRequest:r.apiUrl+"property?",request:"",results:null,total_results:-1,error:null,searching:!1},d.doSearch=o,d.addFilter=l,d.removeFilter=s,d.addOrderby=i,d.removeOrderby=n,d.updateQuery=c}];return{restrict:"EA",scope:!0,link:function(r,e,a,t){},templateUrl:"explorer.bootstrap.html",controller:a,controllerAs:"vm",bindToController:{search:"=",loader:"="}}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",r),r.$inject=["ApiConfig","PropertyFactory"]}();
