...
!function(){"use strict";function r(r){function e(){function e(){}function a(){l.data.searchForm.filter.push({value:"",operator:"",join:"and"})}function t(r){var e=l.data.searchForm.filter.indexOf(r);l.data.searchForm.filter.splice(e,1)}function o(){l.data.searchForm.orderby.push({value:""})}function i(){console.log("building the query");var e=r.apiUrl+"property?",a=0,t=[];""!==l.data.searchForm.select&&(e+="$select="+l.data.searchForm.select),l.data.searchForm.filter.length&&(e+=""!==l.data.searchForm.select?"&$filter=":"$filter="),t=l.data.searchForm.filter.map(function(r){return r.value});for(var a=0;a<l.data.searchForm.filter.length;a++)e+=t[a],""!=l.data.searchForm.filter[a].value&&(e+=" "+l.data.searchForm.filter[a].join),a+1<l.data.searchForm.filter.length&&(e+=" ");l.data.searchForm.orderby.length&&(e+=""!==l.data.searchForm.select&&l.data.searchForm.filter.length?"&$ordery=":"$orderby="),e+=l.data.searchForm.orderby.map(function(r){return r.value+" "+r.direction}).join(", "),""!=l.data.searchForm.top&&(e+="$top="+l.data.searchForm.top),""!=l.data.searchForm.skip&&(e+="$skip="+l.data.searchForm.skip),l.data.request=e}var l=this;l.data={searchForm:{select:"",filter:[{value:"",operator:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},request:"",results:[]},l.search=e,l.addFilter=a,l.removeFilter=t,l.addOrderby=o,l.updateQuery=i}return{restrict:"EA",scope:{},templateUrl:"explorer.bootstrap.html",controller:e,controllerAs:"vm",bindToController:!0}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",r),r.$inject=["ApiConfig"]}();
