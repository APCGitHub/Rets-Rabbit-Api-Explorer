!function(){"use strict";angular.module("rr.api.v2.explorer",["rets-rabbit-angular","ngAnimate","nemLogging","ui-leaflet","rr.api.v2.explorer.directives","rr.api.v2.explorer.filters","rr.api.v2.explorer.templates"])}();
...
!function(){"use strict";function e(e,r){var t=["$scope","$interval","$document","PropertyFactory","leafletData","leafletDrawEvents",function(r,t,a,o,l,n){function i(e){if(e){p.data.total_results=-1,p.data.error=null,p.data.results=null,p.data.searching=!0;var r=new Date;o.search(p.data.request).then(function(e){a.scrollToElement(y,70,300);var t=new Date;p.data.error=null,p.data.results=e,p.data.total_results=e.value.length,p.data.searching=!1,m(t.getTime()-r.getTime())},function(e){a.scrollToElement(y,70,300),p.data.query_time=-1,p.data.searching=!1,p.data.error=e?e.error:{}})}}function c(){p.data.searchForm.filter.push({value:"",join:"and"})}function d(e){var r=p.data.searchForm.filter.indexOf(e);p.data.searchForm.filter.splice(r,1),f()}function s(){p.data.searchForm.orderby.push({value:"",direction:"asc"})}function u(e){var r=p.data.searchForm.orderby.indexOf(e);p.data.searchForm.orderby.splice(r,1),f()}function f(){var r="",t=0,a=[0,0,0,0,0];if(""!==p.data.searchForm.select&&(a[0]=1,r+="$select="+p.data.searchForm.select),p.data.searchForm.filter.length)for(a[1]=1,r+=a[0]?"&$filter=":"$filter=",t=0;t<p.data.searchForm.filter.length;t++)r+=p.data.searchForm.filter[t].value,""!==p.data.searchForm.filter[t].value&&t+1<p.data.searchForm.filter.length&&(r+=" "+p.data.searchForm.filter[t].join),t+1<p.data.searchForm.filter.length&&(r+=" ");p.data.searchForm.orderby.length&&(a[2]=1,r+=a[0]+a[1]>0?"&$orderby=":"$orderby=",r+=p.data.searchForm.orderby.map(function(e){return""!==e.value?e.value+" "+e.direction:""}).join(", ")),""!=p.data.searchForm.top&&(a[3]=1,r+=a[0]+a[1]+a[2]>0?"&$top=":"$top=",r+=p.data.searchForm.top),""!=p.data.searchForm.skip&&(a[4]=1,r+=a[0]+a[1]+a[2]+a[3]>0?"&$skip=":"$skip=",r+=p.data.searchForm.skip),p.data.fullRequest=e.apiUrl+"property?"+r,p.data.request=r}function m(e){p.data.query_time=0;var r=5;e>750?p.data.query_time=e:h=t(function(r){p.data.query_time==e?t.cancel(h):p.data.query_time++},r)}var h,p=this,y=angular.element(document.getElementById("rr-query-results")),v=new L.FeatureGroup;r.$watch(angular.bind(this,function(){return this.search}),function(e){e&&"undefined"!==e&&void 0!==e&&"function"!=typeof e&&(p.data.searchForm.select=e.query.select,p.data.searchForm.filter=e.query.filter,p.data.searchForm.orderby=e.query.orderby,p.data.searchForm.top=e.query.top,p.data.searchForm.skip=e.query.skip,p.data.error=null,p.data.results=null,p.data.searching=!1,p.data.total_results=-1,f())}),p.data={searchForm:{select:"",filter:[{value:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},map:{center:{lat:39.9612,lng:-82.9988,zoom:10},drawOptions:{position:"bottomright",draw:{polyline:{metric:!1},polygon:{metric:!1,showArea:!0,drawError:{color:"#b00b00",timeout:1e3},shapeOptions:{color:"blue"}},circle:{showArea:!0,metric:!1,shapeOptions:{color:"#662d91"}},marker:!1},edit:{featureGroup:v,remove:!0}}},fullRequest:e.apiUrl+"property?",request:"",results:null,total_results:-1,error:null,searching:!1,query_time:-1},p.doSearch=i,p.addFilter=c,p.removeFilter=d,p.addOrderby=s,p.removeOrderby=u,p.updateQuery=f,l.getMap("rr-map").then(function(e){});var F={created:function(e,r,t,a,o){v.addLayer(r.layer)},edited:function(e){},deleted:function(e){var r;r=e.layers,v.removeLayer(layer)},drawstart:function(e){},drawstop:function(e){},editstart:function(e){},editstop:function(e){},deletestart:function(e){},deletestop:function(e){}},g=n.getAvailableEvents();g.forEach(function(e){r.$on("leafletDirectiveDraw."+e,function(r,t){console.log(e);var a,o,l,n;a=t.leafletEvent,o=t.leafletObject,l=t.model,n=t.modelName,F[e.replace("draw:","")](r,a,o,l,n)})})}];return{restrict:"EA",scope:!0,link:function(e,r,t,a){},templateUrl:"explorer.bootstrap.html",controller:t,controllerAs:"vm",bindToController:{search:"=",loader:"="}}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",e),e.$inject=["ApiConfig","PropertyFactory"]}();
