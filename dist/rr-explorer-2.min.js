...
!function(){"use strict";function r(r,e){var a=["$scope","PropertyFactory",function(e,a){function t(r){r&&(n.data.total_results=-1,n.data.error=null,n.data.results=null,n.data.searching=!0,a.search(n.data.request).then(function(r){n.data.error=null,n.data.results=r,n.data.total_results=r.value.length,n.data.searching=!1},function(r){n.data.searching=!1,n.data.error=r.error}))}function o(){n.data.searchForm.filter.push({value:"",operator:"",join:"and"})}function l(r){var e=n.data.searchForm.filter.indexOf(r);n.data.searchForm.filter.splice(e,1),c()}function i(){n.data.searchForm.orderby.push({value:"",direction:"asc"})}function s(r){var e=n.data.searchForm.orderby.indexOf(r);n.data.searchForm.orderby.splice(e,1),c()}function c(){var e="",a=0,t=[0,0,0,0,0];if(""!==n.data.searchForm.select&&(t[0]=1,e+="$select="+n.data.searchForm.select),n.data.searchForm.filter.length)for(t[1]=1,e+=t[0]?"&$filter=":"$filter",a=0;a<n.data.searchForm.filter.length;a++)e+=n.data.searchForm.filter[a].value,""!==n.data.searchForm.filter[a].value&&a+1<n.data.searchForm.filter.length&&(e+=" "+n.data.searchForm.filter[a].join),a+1<n.data.searchForm.filter.length&&(e+=" ");n.data.searchForm.orderby.length&&(t[2]=1,e+=t[0]+t[1]>0?"&$orderby=":"$orderby=",e+=n.data.searchForm.orderby.map(function(r){return""!==r.value?r.value+" "+r.direction:""}).join(", ")),""!=n.data.searchForm.top&&(t[3]=1,e+=t[0]+t[1]+t[2]>0?"&$top=":"$top=",e+=n.data.searchForm.top),""!=n.data.searchForm.skip&&(t[4]=1,e+=t[0]+t[1]+t[2]+t[3]>0?"&$skip=":"$skip=",e+=n.data.searchForm.skip),n.data.fullRequest=r.apiUrl+"property?"+e,n.data.request=e}var n=this;e.$watch(angular.bind(this,function(){return this.search}),function(r){r&&"undefined"!==r&&void 0!==r&&"function"!=typeof r&&(n.data.searchForm.select=r.query.select,n.data.searchForm.filter=r.query.filter,n.data.searchForm.orderby=r.query.orderby,n.data.searchForm.top=r.query.top,n.data.searchForm.skip=r.query.skip,c())}),n.data={searchForm:{select:"",filter:[{value:"",operator:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},fullRequest:r.apiUrl+"property?",request:"",results:null,total_results:-1,error:null,searching:!1},n.doSearch=t,n.addFilter=o,n.removeFilter=l,n.addOrderby=i,n.removeOrderby=s,n.updateQuery=c}];return{restrict:"EA",scope:!0,link:function(r,e,a,t){},templateUrl:"explorer.bootstrap.html",controller:a,controllerAs:"vm",bindToController:{search:"="}}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",r),r.$inject=["ApiConfig","PropertyFactory"]}();
