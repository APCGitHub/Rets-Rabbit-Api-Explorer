...
!function(){"use strict";function e(e,r){var a=["$scope","$interval","$document","PropertyFactory","uiGmapGoogleMapApi",function(r,a,t,o,l){function i(e){if(e){g.data.total_results=-1,g.data.error=null,g.data.results=null,g.data.searching=!0;var r=new Date;o.search(g.data.request).then(function(e){t.scrollToElement(h,70,300);var a=new Date;g.data.error=null,g.data.results=e,g.data.total_results=e.value.length,g.data.searching=!1,p(a.getTime()-r.getTime())},function(e){t.scrollToElement(h,70,300),g.data.query_time=-1,g.data.searching=!1,g.data.error=e?e.error:{}})}}function n(){g.data.searchForm.filter.push({value:"",join:"and"})}function d(e){var r=g.data.searchForm.filter.indexOf(e);g.data.searchForm.filter.splice(r,1),u()}function s(){g.data.searchForm.orderby.push({value:"",direction:"asc"})}function c(e){var r=g.data.searchForm.orderby.indexOf(e);g.data.searchForm.orderby.splice(r,1),u()}function u(){var r="",a=0,t=[0,0,0,0,0];if(""!==g.data.searchForm.select&&(t[0]=1,r+="$select="+g.data.searchForm.select),g.data.searchForm.filter.length)for(t[1]=1,r+=t[0]?"&$filter=":"$filter=",a=0;a<g.data.searchForm.filter.length;a++)r+=g.data.searchForm.filter[a].value,""!==g.data.searchForm.filter[a].value&&a+1<g.data.searchForm.filter.length&&(r+=" "+g.data.searchForm.filter[a].join),a+1<g.data.searchForm.filter.length&&(r+=" ");g.data.searchForm.orderby.length&&(t[2]=1,r+=t[0]+t[1]>0?"&$orderby=":"$orderby=",r+=g.data.searchForm.orderby.map(function(e){return""!==e.value?e.value+" "+e.direction:""}).join(", ")),""!=g.data.searchForm.top&&(t[3]=1,r+=t[0]+t[1]+t[2]>0?"&$top=":"$top=",r+=g.data.searchForm.top),""!=g.data.searchForm.skip&&(t[4]=1,r+=t[0]+t[1]+t[2]+t[3]>0?"&$skip=":"$skip=",r+=g.data.searchForm.skip),g.data.fullRequest=e.apiUrl+"property?"+r,g.data.request=r}function p(e){g.data.query_time=0;var r=5;e>750?g.data.query_time=e:m=a(function(r){g.data.query_time==e?a.cancel(m):g.data.query_time++},r)}var m,g=this,h=angular.element(document.getElementById("rr-query-results"));r.$watch(angular.bind(this,function(){return this.search}),function(e){e&&"undefined"!==e&&void 0!==e&&"function"!=typeof e&&(g.data.searchForm.select=e.query.select,g.data.searchForm.filter=e.query.filter,g.data.searchForm.orderby=e.query.orderby,g.data.searchForm.top=e.query.top,g.data.searchForm.skip=e.query.skip,g.data.error=null,g.data.results=null,g.data.searching=!1,g.data.total_results=-1,u())}),g.data={searchForm:{select:"",filter:[{value:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},map:{center:{latitude:39.9612,longitude:-82.9988},zoom:10,drawingManagerOptions:{},drawingManagerControl:{}},fullRequest:e.apiUrl+"property?",request:"",results:null,total_results:-1,error:null,searching:!1,query_time:-1},l.then(function(e){console.log("google maps is ready now"),g.data.map.drawingManagerOptions={drawingMode:google.maps.drawing.OverlayType.MARKER,drawingControl:!0,drawingControlOptions:{position:google.maps.ControlPosition.TOP_CENTER,drawingModes:[google.maps.drawing.OverlayType.MARKER,google.maps.drawing.OverlayType.CIRCLE,google.maps.drawing.OverlayType.POLYGON,google.maps.drawing.OverlayType.POLYLINE,google.maps.drawing.OverlayType.RECTANGLE]},circleOptions:{fillColor:"#ffff00",fillOpacity:1,strokeWeight:5,clickable:!1,editable:!0,zIndex:1}}}),g.doSearch=i,g.addFilter=n,g.removeFilter=d,g.addOrderby=s,g.removeOrderby=c,g.updateQuery=u}];return{restrict:"EA",scope:!0,link:function(e,r,a,t){},templateUrl:"explorer.bootstrap.html",controller:a,controllerAs:"vm",bindToController:{search:"=",loader:"="}}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",e),e.$inject=["ApiConfig","PropertyFactory"]}();
