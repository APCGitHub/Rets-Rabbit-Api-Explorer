...
!function(){"use strict";function r(r,e){function a(){function a(r){r&&(i.data.total_results=-1,i.data.error=null,i.data.results=null,i.data.searching=!0,e.search(i.data.request).then(function(r){i.data.error=null,i.data.results=r,i.data.total_results=r.value.length,i.data.searching=!1},function(r){i.data.searching=!1,i.data.error=r.error}))}function t(){i.data.searchForm.filter.push({value:"",operator:"",join:"and"})}function o(r){var e=i.data.searchForm.filter.indexOf(r);i.data.searchForm.filter.splice(e,1),c()}function l(){i.data.searchForm.orderby.push({value:"",direction:"asc"})}function s(r){var e=i.data.searchForm.orderby.indexOf(r);i.data.searchForm.orderby.splice(e,1),c()}function c(){var e="",a=0,t=[0,0,0,0,0];if(""!==i.data.searchForm.select&&(t[0]=1,e+="$select="+i.data.searchForm.select),i.data.searchForm.filter.length)for(t[1]=1,e+=t[0]?"&$filter=":"$filter",a=0;a<i.data.searchForm.filter.length;a++)e+=i.data.searchForm.filter[a].value,""!==i.data.searchForm.filter[a].value&&a+1<i.data.searchForm.filter.length&&(e+=" "+i.data.searchForm.filter[a].join),a+1<i.data.searchForm.filter.length&&(e+=" ");i.data.searchForm.orderby.length&&(t[2]=1,e+=t[0]+t[1]>0?"&$orderby=":"$orderby=",e+=i.data.searchForm.orderby.map(function(r){return""!==r.value?r.value+" "+r.direction:""}).join(", ")),""!=i.data.searchForm.top&&(t[3]=1,e+=t[0]+t[1]+t[2]>0?"&$top=":"$top=",e+=i.data.searchForm.top),""!=i.data.searchForm.skip&&(t[4]=1,e+=t[0]+t[1]+t[2]+t[3]>0?"&$skip=":"$skip=",e+=i.data.searchForm.skip),i.data.fullRequest=r.apiUrl+"property?"+e,i.data.request=e}var i=this;i.data={searchForm:{select:"",filter:[{value:"",operator:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},fullRequest:r.apiUrl+"property?",request:"",results:null,total_results:-1,error:null,searching:!1},i.search=a,i.addFilter=t,i.removeFilter=o,i.addOrderby=l,i.removeOrderby=s,i.updateQuery=c}return{restrict:"EA",scope:{search:"@"},link:function(r,e,a,t){console.log("search: "+r.search),r.$watch("search",function(r){console.log(r)})},templateUrl:"explorer.bootstrap.html",controller:a,controllerAs:"vm",bindToController:!0}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",r),r.$inject=["ApiConfig","PropertyFactory"]}();
