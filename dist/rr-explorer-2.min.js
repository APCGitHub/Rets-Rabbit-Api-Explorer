...
!function(){"use strict";function e(e,r){var a=["$scope","$interval","$document","PropertyFactory","uiGmapGoogleMapApi",function(r,a,t,o,l){function i(e){if(e){h.data.total_results=-1,h.data.error=null,h.data.results=null,h.data.searching=!0;var r=new Date;o.search(h.data.request).then(function(e){t.scrollToElement(f,70,300);var a=new Date;h.data.error=null,h.data.results=e,h.data.total_results=e.value.length,h.data.searching=!1,p(a.getTime()-r.getTime())},function(e){t.scrollToElement(f,70,300),h.data.query_time=-1,h.data.searching=!1,h.data.error=e?e.error:{}})}}function n(){h.data.searchForm.filter.push({value:"",join:"and"})}function s(e){var r=h.data.searchForm.filter.indexOf(e);h.data.searchForm.filter.splice(r,1),u()}function d(){h.data.searchForm.orderby.push({value:"",direction:"asc"})}function c(e){var r=h.data.searchForm.orderby.indexOf(e);h.data.searchForm.orderby.splice(r,1),u()}function u(){var r="",a=0,t=[0,0,0,0,0];if(""!==h.data.searchForm.select&&(t[0]=1,r+="$select="+h.data.searchForm.select),h.data.searchForm.filter.length)for(t[1]=1,r+=t[0]?"&$filter=":"$filter=",a=0;a<h.data.searchForm.filter.length;a++)r+=h.data.searchForm.filter[a].value,""!==h.data.searchForm.filter[a].value&&a+1<h.data.searchForm.filter.length&&(r+=" "+h.data.searchForm.filter[a].join),a+1<h.data.searchForm.filter.length&&(r+=" ");h.data.searchForm.orderby.length&&(t[2]=1,r+=t[0]+t[1]>0?"&$orderby=":"$orderby=",r+=h.data.searchForm.orderby.map(function(e){return""!==e.value?e.value+" "+e.direction:""}).join(", ")),""!=h.data.searchForm.top&&(t[3]=1,r+=t[0]+t[1]+t[2]>0?"&$top=":"$top=",r+=h.data.searchForm.top),""!=h.data.searchForm.skip&&(t[4]=1,r+=t[0]+t[1]+t[2]+t[3]>0?"&$skip=":"$skip=",r+=h.data.searchForm.skip),h.data.fullRequest=e.apiUrl+"property?"+r,h.data.request=r}function p(e){h.data.query_time=0;var r=5;e>750?h.data.query_time=e:m=a(function(r){h.data.query_time==e?a.cancel(m):h.data.query_time++},r)}var m,h=this,f=angular.element(document.getElementById("rr-query-results"));l.then(function(e){console.log("hallo")}),r.$watch(angular.bind(this,function(){return this.search}),function(e){e&&"undefined"!==e&&void 0!==e&&"function"!=typeof e&&(h.data.searchForm.select=e.query.select,h.data.searchForm.filter=e.query.filter,h.data.searchForm.orderby=e.query.orderby,h.data.searchForm.top=e.query.top,h.data.searchForm.skip=e.query.skip,h.data.error=null,h.data.results=null,h.data.searching=!1,h.data.total_results=-1,u())}),h.data={searchForm:{select:"",filter:[{value:"",join:"and"}],orderby:[{value:"",direction:"asc"}],top:"",skip:""},map:{center:{lat:39.9612,lng:-82.9988},zoom:10,drawingManagerOptions:{drawingMode:google.maps.drawing.OverlayType.MARKER,drawingControl:!0,drawingControlOptions:{position:google.maps.ControlPosition.TOP_CENTER,drawingModes:[google.maps.drawing.OverlayType.MARKER,google.maps.drawing.OverlayType.CIRCLE,google.maps.drawing.OverlayType.POLYGON,google.maps.drawing.OverlayType.POLYLINE,google.maps.drawing.OverlayType.RECTANGLE]},circleOptions:{fillColor:"#ffff00",fillOpacity:1,strokeWeight:5,clickable:!1,editable:!0,zIndex:1}},drawingManagerControl:{}},fullRequest:e.apiUrl+"property?",request:"",results:null,total_results:-1,error:null,searching:!1,query_time:-1},h.doSearch=i,h.addFilter=n,h.removeFilter=s,h.addOrderby=d,h.removeOrderby=c,h.updateQuery=u}];return{restrict:"EA",scope:!0,link:function(e,r,a,t){},templateUrl:"explorer.bootstrap.html",controller:a,controllerAs:"vm",bindToController:{search:"=",loader:"="}}}angular.module("rr.api.v2.explorer.directive.explorer",[]).directive("apiExplorer",e),e.$inject=["ApiConfig","PropertyFactory"]}();
